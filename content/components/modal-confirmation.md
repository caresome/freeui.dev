...
publish_at: 2025-12-14 11:50:00
---
...
<div data-preview-only class="flex min-h-[400px] items-center justify-center p-4">
    <div x-data="{ open: false }" @keydown.escape.window="if (open) { open = false; $refs.trigger.focus(); }">
        ...
        <button
            ...
            @click="open = true"
            type="button"
            class="inline-flex items-center gap-2 rounded-lg bg-red-600 px-4 py-2.5 text-sm font-medium text-white shadow-sm transition-all duration-150 hover:bg-red-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 active:scale-[0.98]"
        >
            <svg
                class="h-4 w-4"
                fill="none"
            ...
            >
                ...
                <div class="mt-6 flex gap-3">
                    ...
                    <button
                        @click="open = false; $refs.trigger.focus();"
                        type="button"
                        class="flex-1 rounded-lg bg-red-600 px-4 py-2.5 text-sm font-medium text-white transition-all duration-150 hover:bg-red-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 active:scale-[0.98]"
                    >
                        Delete
                    </button>
                </div>
