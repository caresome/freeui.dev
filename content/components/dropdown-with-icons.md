...
github: caresome
dependencies: []
publish_at: 2025-12-14 11:10:00
---
...
<div data-preview-only class="flex min-h-[350px] items-start justify-center p-8">
    ...
    >
        ...
        <div
            ...
            @click.outside="close()"
            class="absolute left-0 z-10 mt-2 w-56 origin-top-left rounded-xl border border-neutral-200 bg-white p-1.5 shadow-lg dark:border-neutral-700 dark:bg-neutral-800"
            role="menu"
        ...
        >
            ...
            <a
                x-ref="delete"
                href="#"
                class="flex items-center gap-3 rounded-lg px-4 py-2.5 text-sm text-red-600 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-red-600 dark:text-red-400 dark:focus-visible:outline-red-400"
