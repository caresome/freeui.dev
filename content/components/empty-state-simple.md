...
<div data-preview-only class="flex min-h-[400px] items-center justify-center p-8">
    <div class="text-center">
        ...
        <h3 class="mt-2 text-sm font-semibold text-neutral-900 dark:text-neutral-50">No projects</h3>
        <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">Get started by creating a new project.</p>
        <div class="mt-6">
            <button
                type="button"
