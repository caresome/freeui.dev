        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="flex items-center gap-8">
                    ...
                    <a
                        href="#"
                        class="group flex items-center gap-2.5 rounded-lg focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neutral-900 dark:focus-visible:outline-neutral-100"
                    ...
                    <div class="hidden md:flex md:items-center md:gap-1" role="menubar" aria-label="Primary navigation">
                        <a
                            href="#"
                            class="rounded-lg bg-neutral-100 px-3 py-2 text-sm font-medium text-neutral-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neutral-900 dark:bg-neutral-800 dark:text-neutral-50 dark:focus-visible:outline-neutral-100"
                            role="menuitem"
                            aria-current="page"
                        >
                            Dashboard
