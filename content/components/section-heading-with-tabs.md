        ...
        <div class="border-b border-neutral-200 dark:border-neutral-800">
            ...
            <nav class="mt-4 -mb-px flex gap-6" aria-label="Tabs">
                <button
                    ...
                    class="border-b-2 px-1 pb-3 text-sm font-medium whitespace-nowrap transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neutral-900 dark:focus-visible:outline-neutral-100"
                >
                    All
                    <span
                        :class="activeTab === 'all'
