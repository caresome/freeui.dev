...
<div data-preview-only class="mx-auto max-w-md">
    ...
    >
        ...
        <div class="mt-4">
            ...
            <div class="flex justify-between gap-2">
                <button
                    ...
                    class="flex h-12 w-12 items-center justify-center rounded-lg text-lg font-semibold transition-all duration-150 hover:scale-105 active:scale-95"
                >
                    1
                </button>
                <button
        ...
        <div
            class="mt-5 flex items-center justify-between border-t border-neutral-200/80 pt-4 dark:border-neutral-800/80"
        >
            <button
                type="button"
                class="inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium text-neutral-600 transition-all duration-150 hover:bg-neutral-100 hover:text-neutral-900 dark:text-neutral-400 dark:hover:bg-neutral-800 dark:hover:text-neutral-50"
            >
            ...
            <button
                ...
                class="inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium shadow-sm transition-all duration-150 active:scale-[0.98]"
            >
                Next
                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
