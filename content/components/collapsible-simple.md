    ...
    <div class="w-full max-w-md space-y-4">
        ...
        >
            <button
                @click="open = !open"
                type="button"
                class="flex w-full items-center justify-between px-4 py-3 text-left text-sm font-medium text-neutral-900 focus:outline-none focus-visible:bg-neutral-50 dark:text-neutral-50 dark:focus-visible:bg-neutral-700"
            ...
            >
                ...
                <svg
                    class="h-5 w-5 text-neutral-500 transition-transform duration-200 dark:text-neutral-400"
            ...
            <div
                ...
                x-collapse
                x-cloak
                class="border-t border-neutral-200 px-4 py-3 text-sm text-neutral-500 dark:border-neutral-700 dark:text-neutral-400"
            >
