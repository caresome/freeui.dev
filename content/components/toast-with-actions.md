...
<div data-preview-only class="flex min-h-[200px] items-center justify-center p-8">
    <div x-data="{ open: true }" class="relative">
        ...
        <div
            ...
            class="absolute bottom-full left-1/2 mb-4 flex w-max -translate-x-1/2 items-center gap-4 rounded-xl border border-neutral-200 bg-white p-4 shadow-lg dark:border-neutral-700 dark:bg-neutral-800"
            role="status"
            aria-live="polite"
        >
