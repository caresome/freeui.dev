---
slug: command-palette-simple
title: Command Palette Simple
...
<div data-preview-only class="flex min-h-[500px] items-start justify-center p-8">
    <div
        x-data="{
            ...
            items: [
                ...
                { id: 'help', label: 'Go to Help Center' }
            ],
            get filteredItems() {
    ...
    >
        ...
        >
            ...
            <!-- Results -->
            <div x-ref="listbox" id="command-list" role="listbox" class="max-h-72 overflow-y-auto p-2">
                ...
                <template x-for="(item, index) in filteredItems" :key="item.id">
                    <button
                        ...
                        class="flex w-full items-center gap-3 rounded-lg px-4 py-2.5 text-left text-sm transition-colors focus:outline-none"
