            ...
            >
                ...
                <div class="relative h-40">
                    ...
                    <div class="absolute bottom-3 left-3">
                        ...
                        >
                            <svg
                                class="mr-0.5 h-3 w-3 text-amber-500"
                                fill="currentColor"
                                viewBox="0 0 20 20"
                                aria-hidden="true"
                            >
                ...
                <div class="p-4">
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        ...
                        <button
                            type="button"
                            class="rounded-lg bg-neutral-900 px-3 py-1.5 text-sm font-medium text-white transition-all duration-150 hover:bg-neutral-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neutral-900 active:scale-[0.98] dark:bg-white dark:text-neutral-900 dark:hover:bg-neutral-100 dark:focus-visible:outline-neutral-100"
                        >
                            Book now
                        </button>
                    </div>
