---
slug: command-palette-with-preview
title: Command Palette with Preview
category: navigation
github: caresome
dependencies:
...
<div data-preview-only class="flex min-h-[550px] items-start justify-center p-8">
    <div
        x-data="{
            ...
            activeIndex: 0,
            items: [
                { id: 'dashboard', label: 'Dashboard', description: 'View your project overview and key metrics', icon: 'chart' },
                { id: 'projects', label: 'Projects', description: 'Browse and manage all your projects', icon: 'folder' },
                { id: 'tasks', label: 'Tasks', description: 'View and organize your task list', icon: 'clipboard' },
                { id: 'team', label: 'Team', description: 'Manage team members and permissions', icon: 'users' },
                { id: 'settings', label: 'Settings', description: 'Configure your account preferences', icon: 'cog' },
                { id: 'analytics', label: 'Analytics', description: 'Deep dive into your data and insights', icon: 'chart' }
            ],
            get filteredItems() {
    ...
    >
        ...
        <div
            ...
            class="fixed top-[15%] left-1/2 z-50 w-full max-w-3xl -translate-x-1/2 overflow-hidden rounded-xl border border-neutral-200 bg-white shadow-2xl dark:border-neutral-700 dark:bg-neutral-800"
            role="dialog"
            aria-modal="true"
        ...
        >
            ...
            <div class="border-b border-neutral-200 dark:border-neutral-700">
                <div class="flex items-center px-4">
                    ...
                    <input
                        ...
                        aria-controls="command-list-preview"
                    />
                </div>
            </div>
            ...
            <div class="flex">
                ...
                <div
                    x-ref="listbox"
                    id="command-list-preview"
                    role="listbox"
                    class="max-h-80 w-1/2 overflow-y-auto border-r border-neutral-200 p-2 dark:border-neutral-700"
                >
                ...
                <!-- Preview Panel -->
                <div class="flex w-1/2 items-center justify-center bg-neutral-50 p-6 dark:bg-neutral-900">
                    <template x-if="selectedItem">
                        <div class="text-center">
                            <div
                                class="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-neutral-200 dark:bg-neutral-700"
                            >
                                <!-- Chart icon -->
                                <svg
                                    x-show="selectedItem.icon === 'chart'"
                                ...
                                <!-- Folder icon -->
                                <svg
                                    x-show="selectedItem.icon === 'folder'"
                                    class="h-8 w-8 text-neutral-600 dark:text-neutral-300"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke-width="1.5"
                                ...
                                <!-- Clipboard icon -->
                                <svg
                                    x-show="selectedItem.icon === 'clipboard'"
                                    class="h-8 w-8 text-neutral-600 dark:text-neutral-300"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke-width="1.5"
                                ...
                                <!-- Users icon -->
                                <svg
                                    x-show="selectedItem.icon === 'users'"
                                    class="h-8 w-8 text-neutral-600 dark:text-neutral-300"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke-width="1.5"
                            ...
                            <h3
                                class="mt-4 text-base font-semibold text-neutral-900 dark:text-neutral-50"
                                x-text="selectedItem.label"
                            ></h3>
                            <p
                    ...
                    <template x-if="!selectedItem">
                        <div class="text-center text-sm text-neutral-500 dark:text-neutral-400">No item selected</div>
                    </template>
                </div>
            </div>
        </div>
